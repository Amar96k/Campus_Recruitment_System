...
<html lang="en">
    ...
    <nav class="navbar navbar-default" style="margin-bottom: 0; height: 80px; background-color: white; border-color: transparent;">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          <a class="navbar-brand" style=" font-family: Arial, Helvetica, sans-serif; font-size: 30px; color: #053a5a; line-height: 42px;" href="index.php"> <b>PVPIT</b> </a>
        </div>
  ...
  <section>
    <div class="container1">
      <img src="./img/PVPIT.jpg" alt="Snow">
